...
def get_densenet121(path_state_dict, device):
    ...
    if path_state_dict:
        ...
        # need "features.denseblock1.denselayer1.norm1.weight", "features.denseblock1.denselayer1.norm1.bias",
        # no need "features.denseblock1.denselayer1.norm.1.weight", "features.denseblock1.denselayer1.norm.1.bias"
